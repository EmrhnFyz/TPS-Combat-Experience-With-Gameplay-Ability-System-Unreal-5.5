...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FWaitSpawnEnemiesDelegate, const TArray<ATPSCombatEnemyCharacter*>&, SpawnedEnemies);

/**
 * 
 */
UCLASS()
class TPSCOMBAT_API UAbilityTask_WaitSpawnEnemies : public UAbilityTask
{
	GENERATED_BODY()
