...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	if (!CurrentLockedActor ||
		UTPSCombatFunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor, TPSCombatGameplayTags::Shared_Status_Death) ||
	...
	const bool bShouldOverrideRotation =
		!UTPSCombatFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), TPSCombatGameplayTags::Player_Status_Roll)
		&&
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	if (!DrawnTargetLockWidget)
	{
		...
		DrawnTargetLockWidget = CreateWidget<UTPSCombatWidgetBase>(GetHeroControllerFromActorInfo(), TargetLockWidgetClass);
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	if (InSwitchDirectionTag == TPSCombatGameplayTags::Player_Event_SwitchTarget_Left)
	{
